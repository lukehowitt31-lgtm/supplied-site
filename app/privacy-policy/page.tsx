...
export default function PrivacyPolicyPage() {
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated="March 24, 2026">
      <p>
        This privacy notice for Supplied Agency Ltd (doing business as Supplied)
        (&lsquo;<strong>we</strong>&rsquo;, &lsquo;<strong>us</strong>&rsquo;,
        or &lsquo;<strong>our</strong>&rsquo;), describes how and why we might
        collect, store, use, and/or share (&lsquo;<strong>process</strong>
        &rsquo;) your information when you use our services (&lsquo;
        <strong>Services</strong>&rsquo;), such as when you:
      </p>
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>Project and packaging enquiry details</li>
      ...
      <h3>Knowledge Hub</h3>
      <p>
        Our Website features an AI-powered Knowledge Hub where you can ask
        questions about our packaging services. Questions submitted to the
        Knowledge Hub may be processed by third-party AI services (including
        Anthropic and OpenAI) to generate responses. We do not use your
        Knowledge Hub conversations for AI training purposes. Conversation data
        may be temporarily stored to provide the service but is not linked to
        your personal identity unless you voluntarily include personal details in
        your questions.
      </p>
      ...
      <ul>
        <li>
          ...
          IP address, device information, browser type, and information about
        ...
        <li>
          ...
          browser type, hardware model, operating system, and system
        ...
        <li>
          ...
          type and settings of the device you use to access the Services. You can
          opt out of allowing us to collect this information either by refusing
          access to the information or by disabling your Location setting on your
          device.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>To save or protect an individual&rsquo;s vital interest</li>
      </ul>
      ...
      <ul>
        <li>
          ...
          given us permission to use your personal information for a specific
      ...
      <ul>
        <li>
          ...
          including hosting providers, content management systems, and AI service
          providers used to power our Knowledge Hub feature.
        </li>
        <li>
      ...
      <p>
        We use a minimal number of essential cookies required for our Website to
        function correctly. We do not currently use any third-party advertising
        or analytics cookies. Our Website also uses browser session storage (not
        cookies) in certain areas to temporarily store information during your
        browsing session.
      </p>
      <p>
      ...
      <p>
        ...
        personal information we process. Our Website is served over HTTPS, and we
        use industry-standard security practices for data storage and
        transmission. However, despite our safeguards and efforts to secure your
      ...
      <p>
        ...
        implementing DNT signals has been finalised. As such, we do not currently
      ...
      <p>
        ...
        will be indicated by an updated &ldquo;Last updated&rdquo; date at the
