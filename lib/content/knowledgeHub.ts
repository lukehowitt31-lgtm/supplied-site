  ...
  faqCategories: [
    {
      ...
      faqs: [
        ...
        { q: "What is the minimum order quantity (MOQ)?", a: "We work with brands ordering at production scale, not sample runs or one-off batches. Mailer boxes typically start at 1,000–3,000 depending on size — larger formats from 1,000, smaller sizes from 3,000. Rigid boxes from 500. Advent calendars from 250. Shipping boxes, paper mailers, and cartonboard boxes from 1,000. Tissue paper from 5,000 sheets. Paper tape from 72 rolls. Other formats such as tubes, inserts, labels, and pouches typically start from 1,000. Printed cans are more flexible on volume. If your volumes sit below these minimums, we are unlikely to be the right partner." },
        { q: "What's the difference between digital and flexo printing?", a: "Digital printing uses CMYK inkjet technology — ideal for full-colour, photographic designs with no plate charges. Flexo printing uses rubber plates to transfer ink — better for simple designs with 1–4 spot colours at higher volumes (2,000+ units) with lower per-unit costs. We'll recommend the right method based on your design, volumes, and budget. Regardless of print method, we work at production volumes rather than sample-run quantities." },
        ...
        { q: "Can you produce printed aluminium cans?", a: "Yes — digitally printed aluminium cans for beers, beverages, wellness drinks, and more. No plate charges and full CMYK capability meaning photographic-quality designs are possible. Volumes are flexible, so they work well for craft beverage brands, limited editions, and new product launches." },
