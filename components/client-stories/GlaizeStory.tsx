        ...
        <Reveal>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
            <div>
              ...
              <p style={{ fontSize: 16, lineHeight: 1.8, color: C.ink60, marginBottom: 28 }}>Great packaging isn&apos;t just about what it looks like on a shelf — it&apos;s about the moment someone opens it. Here&apos;s the Glaize × Aston Martin experience, straight from TikTok.</p>
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 28 }}>
                {["Limited edition packaging worthy of the collaboration", "Aston Martin Green matched precisely", "Delivered in 3.5 weeks — zero delays"].map((item, i) => (
              ...
              <div style={{ padding: "20px 24px", background: C.white, borderRadius: 12, borderLeft: `3px solid ${C.amber}` }}>
                <p style={{ fontFamily: "var(--font-fraunces), serif", fontSize: 15, fontWeight: 400, fontStyle: "italic", color: C.ink, lineHeight: 1.6 }}>&ldquo;They always find a solution for anything you throw at them.&rdquo;</p>
                <span style={{ fontSize: 12, color: C.ink40, marginTop: 4, display: "block" }}>— Glaize Team</span>
              </div>
            </div>
            <TikTokPlayer src="/videos/GlazieTiktok.mp4" />
          </div>
        </Reveal>
      </section>
