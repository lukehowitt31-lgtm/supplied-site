...
const heroProducts = [
  { id: "mailer-boxes", title: "Mailer Boxes", href: "/products/mailer-boxes", image: "/images/products/SpacegoodsMailerBoxHero.jpg" },
          ...
          <div className="lg:sticky lg:top-32">
            <Reveal>
              ...
              <p className="text-[17px] text-supplied-ink-40 leading-[1.6] max-w-[440px] mb-8">
                From mailer boxes to printed cans — one partnership, one invoice, one point of contact across your entire packaging catalogue.
              </p>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2.5">
                {heroProducts.map((product, i) => (
                  <button
                    ...
                    className={`group/thumb relative aspect-square rounded-xl overflow-hidden transition-all duration-300 ${
                      i === activeIndex
