                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          {content.formSubjects.map((subject) => (
              ...
              <Reveal delay={200}>
                <div className="bg-white rounded-2xl p-7 border border-supplied-ink-05">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-[13px] font-semibold text-supplied-ink">{content.responseTime}</span>
                  </div>
                  <p className="text-[13px] text-supplied-ink-40 leading-[1.55]">
                    {content.responseTimeDetail}
                  </p>
                </div>
              </Reveal>
                  ...
                  <div className="flex flex-col">
                    {content.quickLinks.map((link, i) => (
                      <Link
                        key={i}
                        href={link.href}
                        className={`flex items-center justify-between py-2.5 no-underline group ${i < content.quickLinks.length - 1 ? "border-b border-supplied-ink-05" : ""}`}
                      >
