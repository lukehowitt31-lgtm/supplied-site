      ...
      <Container className="relative z-10 grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12 lg:gap-20 items-center">
        ...
        <div className="max-w-[560px]">
          ...
          <div className="flex items-center gap-4 opacity-0 animate-slide-up [animation-delay:0.75s]">
            <div className="flex">
              <span className="w-9 h-9 rounded-full border-[2.5px] border-supplied-ink flex items-center justify-center text-xs font-bold text-white bg-[#3B82F6] relative z-40">W</span>
              <span className="w-9 h-9 rounded-full border-[2.5px] border-supplied-ink flex items-center justify-center text-xs font-bold text-white bg-[#EC4899] -ml-2 relative z-30">T</span>
